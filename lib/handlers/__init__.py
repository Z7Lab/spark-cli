...
from . import core, llm, comfy, transcribe, playbook, image, tts, engine, train, finetune

REGISTRY: dict = {}
for _mod in (core, llm, comfy, transcribe, playbook, image, tts, engine, train, finetune):
