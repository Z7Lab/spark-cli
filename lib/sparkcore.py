...
_CONFIG = [
    ...
    {"key": "aitoolkit_image", "default": "ostris/aitoolkit:latest",             "env": "SPARK_AITOOLKIT_IMAGE",    "type": "str",  "init": False, "help": "Operator-provided ai-toolkit container image for spark train (pin a digest of a GB10/sm_121-compatible image, like the ComfyUI image)"},
