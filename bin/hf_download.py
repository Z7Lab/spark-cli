...
def usage():
    ...
    print()
    print('Arguments:')
    print('  repo_id     HuggingFace repo  (e.g. unsloth/model-a-GGUF)')
    print('  local_dir   Local destination directory')
    print('  pattern     Glob pattern to match filenames  (e.g. "*UD-Q4_K_XL*")')
    print()
    print('Examples:')
    print('  python3 hf-download.py unsloth/model-a-GGUF ~/models/GLM "*UD-Q4_K_XL*"')
    print('  python3 hf-download.py unsloth/model-c-GGUF ~/models/Qwen "*Q5_K_M*"')
    print()
